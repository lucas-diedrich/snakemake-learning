...
**The instructions were minimally modified to enable users with `mamba` installations to follow along. Please use this branch if you do not have `conda` available on your system**
